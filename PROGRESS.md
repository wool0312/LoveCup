...
- 录入赛果 0:1 并结算 → wool 单场得分 **8.00**
  （`1×5.00 命中 + 净胜球 1 + 精确比分 2 = 8`）。
- 积分页：wool 第1轮 8.00 → 加权 8.00×7% = **0.56**，👑领先，大胜预警出现。
- 历史页：breakdown 明细完整可复核（base 5.00 / gd_bonus 1 / score_bonus 2 / total 8.00）。
